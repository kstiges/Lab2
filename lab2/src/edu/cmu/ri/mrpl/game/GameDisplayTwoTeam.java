...
public class GameDisplayTwoTeam extends JFrame
{
  ...
  public GameDisplayTwoTeam(MazeWorld world, String match_name, String[] robot_names)
  {
    if (world == null) {
  ...
  protected void setupWindow() {
    ...
    //title
    comp = label = new JLabel("Match: " + match_name);
...
//   pane.add(comp, c);
  ...
  public static void main(String args[])
  {
    SwingUtilities.invokeLater(new Runnable() {
      public void run() {
        String robots[] = {"Bot1","Bot2","Bot3","Bot4"};

        try {
          GameDisplayTwoTeam gd = new GameDisplayTwoTeam(new MazeWorld(new File("test.maze")), "Team1 vs Team2", robots);
          ...
          gd.setPose(2, new RealPose2D(6, 0, 3));
          gd.setGoal(2, new RealPose2D(7, 3, 1));

          gd.setPose(3, new RealPose2D(4, 0, 2));
          gd.setGoal(3, new RealPose2D(5, 1, 0));
