...
public class GameClientTwoTeam {
	...
	if (!connectedToServer)
	    return;
	String wallString = "ADDWALL " + m_myName  + " " + mazeX + " " + mazeY + " " + dir;
	...
	if (!connectedToServer)
	    return;
	String goldString = "ADDGOLD "   + m_myName + " " + mazeX + " " + mazeY + " " + dir;
	...
	if (!connectedToServer)
	    return;
	String dropString = "EMPTYDROP "  + m_myName + " " + mazeX + " " + mazeY + " " + dir;
